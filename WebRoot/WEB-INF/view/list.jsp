...
-->
  ...
  <form name="form1" method="post" action="/book_springmvc_mybatis/book/delete">
...
<c:forEach  items="${books}" var="book">
        ...
        <td><a href="/book_springmvc_mybatis/book/preEdit?id=${book.id}">修改</a></td>
      </tr>
</c:forEach>
      <tr>
        <td colspan="7" align="center">
        <input type="submit" name="Submit" value="批量删除">
        <input type="button" name="Submit2" value="添加" onClick="location='/book_springmvc_mybatis/book/preAdd'">
        第${curpage}页
        <c:if test="${curpage>1}">
